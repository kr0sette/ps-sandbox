...
import { accountId, accountParam, visitor, role, visitorParam } from '../../pendo/visitor-metadata.js';
import './body.css';
        ...
        const checkForPendo = () => {
            if (window.pendo) {
                ...
                pendo.initialize({
                    ...
                    account: {
                        id: accountParam || accountId
                    }
                });
            } else {
                console.log('Pendo agent not found');
            }
        };

        setTimeout(checkForPendo, 100);
